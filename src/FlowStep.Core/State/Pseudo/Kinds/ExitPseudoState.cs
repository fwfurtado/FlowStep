...
public class ExitPseudoState<TState, TEvent>(StateHolder<TState, TEvent> holder) : IPseudoState<TState, TEvent>
{
    public PseudoStateKind Kind => PseudoStateKind.Exit;
